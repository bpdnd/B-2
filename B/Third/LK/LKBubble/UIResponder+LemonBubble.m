...
//底部转圈
-(void)showRoundBottomWithTitle:(NSString *)title{
    ...
    [[LemonBubbleView defaultBubbleView] showWithInfo: myInfo];
}
//警告
- (void)showSingleIconBubbleWithTitle:(NSString *)title autoCloseTime: (CGFloat)autoCloseTime{
    LemonBubbleInfo *iconInfo = [self getDefaultRoundProgressBubbleInfo];
    ...
    [[LemonBubbleView defaultBubbleView] showWithInfo: iconInfo autoCloseTime: autoCloseTime];
}
