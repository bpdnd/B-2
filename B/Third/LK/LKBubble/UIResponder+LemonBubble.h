...
// 展示一个底部圆形的无限循环的进度条
#define LKWaitBottomBubble(title) [self showRoundBottomWithTitle: title]
// 展示一个底部警告
#define LKSingleBubble(title,time) [self showSingleIconBubbleWithTitle:title autoCloseTime: time]
